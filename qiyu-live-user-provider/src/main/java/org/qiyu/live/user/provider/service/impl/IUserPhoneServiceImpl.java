...
//            String token = createAndSaveLoginToken(userPhoneDTO.getUserId());
//            System.out.println("token================="+token);
            UserLoginDTO success = UserLoginDTO.loginSuccess(userPhoneDTO.getUserId(), null);
    ...
    private UserLoginDTO registerAndLogin(String phone) {
        ...
        System.out.println("userPhonePO-----------------》"+userPhonePO);
...
//    }
    ...
    public List<UserPhoneDTO> queryByUserId(Long userId) {
        ...
        if (!CollectionUtils.isEmpty(userPhoneDTOS)) {
            userPhoneDTOS.stream().forEach(x -> x.setPhone(x.getPhone()));
